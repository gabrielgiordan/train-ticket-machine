...
public class StationComponent implements StationInterface<StationBean> {
  ...
  /**
   * Instantiates a new station service and get the .csv file using the
   * application.properties to get the path.
   *
   * @param properties the Spring's injected properties from
